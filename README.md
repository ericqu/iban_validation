...
## WASM
While experimental the library can be tested as JS/WASM here: 

## Changes
 - 0.1.16: improved performance, added territories for GB and FR, and more tests, added wasm (experimental for now)
